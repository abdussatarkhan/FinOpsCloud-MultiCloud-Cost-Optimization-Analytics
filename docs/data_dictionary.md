...
## 🏢 Platform: FinOpsCloud: Enterprise Multi-Cloud Cost & FinOps Intelligence
**Schema**: `finops_dw`  
...
### 2. `dim_cloud_accounts`
Dimensional attribute master for Cloud Accounts.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `cloud_accounts_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `cloud_accounts_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_services`
Dimensional attribute master for Services.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `services_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `services_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_k8s_clusters`
Dimensional attribute master for K8S Clusters.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `k8s_clusters_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `k8s_clusters_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_cost_centers`
Dimensional attribute master for Cost Centers.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `cost_centers_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `cost_centers_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### `fact_daily_cloud_spend`
Transactional and snapshot grain telemetry table tracking Daily Cloud Spend.
...
### `fact_ri_savings_plans`
Transactional and snapshot grain telemetry table tracking Ri Savings Plans.
...
### `fact_idle_waste_events`
Transactional and snapshot grain telemetry table tracking Idle Waste Events.
...
### `fact_unit_cost_metrics`
Transactional and snapshot grain telemetry table tracking Unit Cost Metrics.
